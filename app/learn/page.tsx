  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        ...
        {/* Coming Up Next Card */}
        <div className="bg-gradient-to-r from-purple-900/40 to-purple-800/40 rounded-2xl p-8 border border-purple-500/30">
          <p className="text-pink-400 text-sm font-semibold mb-2">Coming Up Next:</p>
          <h3 className="text-foreground text-3xl font-bold mb-3">Build a Linear Regression Model</h3>
          <p className="text-muted-foreground mb-6">Now that the theory is clear, build an interactive model.</p>
          <Link href="/linear-regression">
            <button className="bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white font-semibold px-8 py-3 rounded-lg transition-all">
              Continue →
            </button>
          </Link>
        </div>
